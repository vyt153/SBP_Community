...
$(function () {
	...
	$("#regBtn").click(function(){
		...
		if(subject==""){
			...
			$("#writeFrm").attr("action","galleryMod");
			$("#writeFrm").submit();
		}
	});
			    		...
			    		<table>
			    			<tbody>
			    				...
			    				<tr>
			    					<td class="req">제목</td>
			    					<td>
			    						<input type="text" name="subject" maxlength="50" id="subject" value="${gallery.subject }"/>
			    					</td>
			    				</tr>
			    				<tr>
			    					<td class="contentTD">내용</td>
			    					<td>
			    						<textarea name="content" id="content" wrap="hard" cols="60">${gallery.content }</textarea>
			    					</td>
			    				</tr>
			    				<tr>
			    					<td>파일수정</td>
