	    		...
	    		<div id="contents" class="bbsList">
	    			...
	    			<table id="boardList">
	    				...
	    				<c:forEach var="b" items="${boardList }">
	    					<tr class="prnTr" onclick="read('${b.num}')">
	    						<td>${b.num }
	    						</td>
	    						<td class="subjectTd">${b.subject }
	    						<c:if test="${b.fileName!='' }">
	    						<img src="/images/clip_16x10.png" alt="">
	    						</c:if>
	    						</td>
	    						<td>${b.uname }</td>
	    						<td>${b.regTM }</td>
	    					...
	    					<tr id="listBtnArea">
	    						...
	    						<td colspan="3">
	    							<form name="searchFrm" class="dFlex" id="searchFrm" action="boardSearch">
	    								<div>
...
<!-- 	    						<td colspan="5" id="pagingTd"> -->
<!-- 	    							<span id="moveBlockArea" onclick="moveBlock('','')"> -->
<!-- 	    							&lt;</span> -->
